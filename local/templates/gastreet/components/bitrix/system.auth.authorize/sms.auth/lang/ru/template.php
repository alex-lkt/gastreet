...
$MESS["AUTH_PHONE_PLACEHOLDER"] = "Номер телефона";
$MESS["AUTH_PASSWORD_UPDATE"] = "Обновить пароль";
$MESS["AUTH_GOTO_CODE"] = "Получить SMS код";
$MESS["AUTH_GOTO_SITE"] = "Перейти на сайт";
$MESS["AUTH_CODE"] = "Введите полученный в SMS код";
$MESS["AUTH_ERROR"] = "Ошибка обработки данных";
?>
